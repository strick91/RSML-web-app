...
namespace RSML_web_app.Controllers
{
    public class UnresolvedsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DeviceId,Department,ThreatLevel,TimeOccured")] Unresolved unresolved)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DeviceId,Department,ThreatLevel,TimeOccured")] Unresolved unresolved)
        {
            if (ModelState.IsValid)
            {
